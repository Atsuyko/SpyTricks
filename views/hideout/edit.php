...
<form action="<?= $params['hideout']->getCode() ?>" method="POST">
  <div class="form-group mb-3">
    ...
    <input type="text" class="form-control" name="address" id="address" value="<?= $params['hideout']->getAddress() ?>">
  </div>
  <div class="form-group mb-3">
    <label for="type">Type</label>
    <input type="text" class="form-control" name="type" id="type" value="<?= $params['hideout']->getType() ?>">
  </div>
  <div class="form-group mb-3">
