...
<form action="<?= $params['target']->getCode() ?>" method="POST">
  <div class="form-group mb-3">
    ...
    <input type="text" class="form-control" name="lastname" id="lastname" value="<?= $params['target']->getLastname() ?>">
  </div>
  <div class="form-group mb-3">
    <label for="firstname">Prénom</label>
    <input type="text" class="form-control" name="firstname" id="firstname" value="<?= $params['target']->getFirstname() ?>">
  </div>
  <div class="form-group mb-3">
    <label for="dob">Date de naissance</label>
    <input type="date" class="form-control" name="dob" id="dob" value="<?= date('Y-m-d', strtotime($params['target']->getDob())) ?>">
  </div>
  <div class="form-group mb-3">
